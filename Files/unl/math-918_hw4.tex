...
\begin{enumerate}
\item Show
that Frobenius split rings are weakly normal.
...
\item (Exercise 23 of [MP]) Let $(R,\mf m,k)$ be a local ring of char $p$ and $d=\dim R$. Prove that the kernel of the natural Frobenius action on $H^d_{\mf m}(R)$ is a proper submodule of $H^d_{\mf m}(R)$.
...
\]
\item There exists an s.o.p. $f_1,\ldots, f_d$, such that the ideal $I=\langle f_1,\ldots, f_d\rangle $ has
\[
I = \langle g \: | \: g^p \in I^{[p]}\rangle.
\]
\end{enumerate}
