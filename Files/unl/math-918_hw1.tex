...
\begin{prop}
Let $(R,\mf m,k)$ be a local ring containing a \emph{coefficient field}, i.e., there exists an injection $\gamma:k\to R$ such that $\pi\circ \gamma$ is an isomorphism, where $\pi$ is the natural surjection $\pi:R\to R/\mf m \cong k$ . Then number of minimal generators for $F_*^eR$ as an $R$-module is
\[
